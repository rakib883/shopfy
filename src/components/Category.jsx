...
const Catagory = async() => {
    // beuty area start
   const Beuty = `${process.env.BASE_URL}/api/catagory/fragrances`
   const beutyData = await GetData(Beuty)

   //Fragrances area start 
   const Fragrances = `${process.env.BASE_URL}/api/catagory/fragrances` 
   const FragrancesData = await GetData(Fragrances)

  //furniture area start
  const furniture = `${process.env.BASE_URL}/api/catagory/furniture` 
  const furnitureData = await GetData(furniture)

  // groceries  area start
  const groceries = `${process.env.BASE_URL}/api/catagory/groceries` 
